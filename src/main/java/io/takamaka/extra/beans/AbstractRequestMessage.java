 ...
 */
public abstract class AbstractRequestMessage extends NotificationBroadcasterSupport {
    ...
    public void notifyMessage(String message) {
        notifyMessage(sequence, message);
    }

    public void notifyMessage(long id, String message) {
    ...
    public void initNotify(NotificationBroadcasterSupport nbs, long sequence, String commandName) {
        this.nbs = nbs;
